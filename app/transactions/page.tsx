    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">PK2 - Transacciones Sospechosas para Análisis</p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex gap-4">
              <div className="flex-1 relative">
                ...
                <Input placeholder="Buscar por ID, comercio o tarjeta..." className="pl-10" />
              </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span className="ml-2 font-medium">{transaction.merchant}</span>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <span className="ml-2 font-mono">{transaction.cardNumber}</span>
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <span className="text-gray-500">Riesgo: {transaction.riskScore}%</span>
                        <span className="text-gray-500">•</span>
