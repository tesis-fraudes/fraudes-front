    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">PK4 - Seguridad y Configuración del Sistema</p>
        </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Notificaciones inmediatas</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Resumen semanal por email</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
