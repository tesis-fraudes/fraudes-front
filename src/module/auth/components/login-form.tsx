      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-xl text-slate-300 mb-12 leading-relaxed">
            Streamline your content creation, manage multiple websites, and boost your productivity
            with our comprehensive CMS platform.
          </p>
          ...
          <blockquote className="border-l-4 border-blue-500 pl-6">
            <p className="text-slate-300 italic mb-2">
              "This CMS has transformed how we manage our content. The interface is intuitive and
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <Link href="/model" className="text-sm text-slate-500 hover:text-slate-700">
                Continue as guest
              </Link>
            </div>
          </form>
